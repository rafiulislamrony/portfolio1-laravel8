...
class MainPagesController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if($request->file('resume')){
            ...
            $main->bc_img = 'storage/pdf/resume.'. $pdf_file->getClientOriginalExtension();
        }
        $main->save();
        return redirect()->route('admin.main')->with('success', "Banner page data has bern updated successfully");
